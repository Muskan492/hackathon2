        ...
        <div className="bg-[#fbebb5]  mx-auto  w-full">
            ...
            <div>
                ...
                <div className=" md:flex-row bg-[#FFFFFF] justify-around mx-auto py-10 px-4">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start  gap-6 ">
                        {/* Product Item */}
                        {[
                            { src: '/hero3.jpg', name: 'Trenton modular sofa_3', price: 'Rs. 25,000.00' },
                            { src: '/hero4.jpg', name: 'Granite dining table with dining chair', price: 'Rs. 25,000.00' },
                            { src: '/hero5.jpg', name: 'Outdoor bar table and stool', price: 'Rs. 25,000.00' },
                            { src: '/hero6.jpg', name: 'Plain console with teak', price: 'Rs. 25,000.00' },
                        ].map((item, index) => (
            ...
            <div className="relative md:w-[1600px] md:h-[450px] mb-12">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-black">
                    <h3 className="text-3xl md:text-5xl font-bold mb-4 items-center">Our Instagram</h3>
